...
async function buildContainerArgs(
  ...
  args.push('-e', `OPENAI_MODEL_SIMPLE=${OPENAI_MODEL_SIMPLE}`);
  args.push('-e', `OPENAI_MODEL_STANDARD=${OPENAI_MODEL_STANDARD}`);
  args.push('-e', `OPENAI_MODEL_COMPLEX=${OPENAI_MODEL_COMPLEX}`);
